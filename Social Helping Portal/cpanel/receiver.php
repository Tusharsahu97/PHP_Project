                        ...
                        <form method="post" action="">
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                              ...
                              <div class="control-group">
                                <textarea class="form-control" name="desc" placeholder="Details About Items Need" ></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
...
if(isset($_POST["sub"]))
{
    ...
    $rname=$_POST["rname"];
     $cn=$_POST["cn"];
      ...
      $dt=date('d-m-Y');
    require'db_conn.php';
    $q1=mysqli_query($conn,"insert into receiver (rname,cn,adhr,rshn,adrs,desc,rcat,dt) values('$rname','$cn','$adhr','$rshn','$adrs','$desc','$rcat','$dt')");
    if($q1)
    {
